...
*/
// Bump cache version whenever core app code changes to avoid stale JS/CSS in PWA windows.
...
self.addEventListener("fetch", (event) => {
  ...
  // app.js / app.css: network-first (prevents stale code after deploy)
  if (url.origin === self.location.origin && (url.pathname.endsWith('/app.js') || url.pathname.endsWith('/app.css'))) {
