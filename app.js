...
(() => {
  ...
  const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxFLUS4K2zSjVC-3TvLOOeRb6JyiwNmlUcG6d753qfAncLlbEgtKUgGsfS3iGoJJMNxMw/exec';
...
function renderKpisSettings(){
  ...
  function openWizard({ customerId=null, proposalId=null }){
    ...
    $('#wizardSub').textContent = 'חובה למלא את כל הפרטים';
    // Status dropdown
    if(statusSelect){
