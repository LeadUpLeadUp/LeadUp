...
function gotoStep(i){
  ...
  function renderCustomerStep(){
    ...
    bindInput('customer_address', v => { d.address = v; if(insuredId==='main'){ p.customer.address = v; } });
    bindInput('customer_city', v => { d.city = v; if(insuredId==='main'){ p.customer.city = v; } });
    bindInput('customer_zip', v => { d.zip = v; if(insuredId==='main'){ p.customer.zip = v; } });
