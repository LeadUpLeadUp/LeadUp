...
function gotoStep(i){
  ...
  function renderCustomerStep(){
    ...
    wizardMain.innerHTML = `
      ...
      <div class="grid3" style="margin-top:10px">
        <div class="field" style="grid-column:1/-1">
          <label for="customer_marital">סטטוס</label>
          <select id="customer_marital">
    ...
    setSelectValue('customer_marital', d.maritalStatus || d.marital || '');
    ...
    bindSelect('customer_marital', v => { d.maritalStatus = v; d.marital = v; });
