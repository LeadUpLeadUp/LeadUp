...
el("modalBack") && el("modalBack").addEventListener("click", (e)=>{
...
/* ===== Filters/Search/Sort ===== */
el("q") && el("q").addEventListener("input", renderLeads);
el("fStatus") && el("fStatus").addEventListener("change", renderLeads);
el("fSource") && el("fSource").addEventListener("change", renderLeads);
el("sortBy") && el("sortBy").addEventListener("change", renderLeads);

/* ===== Buttons ===== */
el("btnAddLead") && el("btnAddLead").addEventListener("click", ()=>openLeadForm());
...
el("btnBackup") && el("btnBackup").addEventListener("click", exportJSON);
